...
namespace FinancialPortal.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,Created,Updated,BudgetId")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,Created,Updated,BudgetId")] Category category)
        {
            if (ModelState.IsValid)
            {
